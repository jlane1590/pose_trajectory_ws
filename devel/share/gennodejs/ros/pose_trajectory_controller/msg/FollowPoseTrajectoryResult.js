...
class FollowPoseTrajectoryResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FollowPoseTrajectoryResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new FollowPoseTrajectoryResult(null);
...
FollowPoseTrajectoryResult.Constants = {
  SUCCESSFUL: 0,
  INVALID_GOAL: -1,
  INVALID_JOINTS: -2,
...
module.exports = FollowPoseTrajectoryResult;
