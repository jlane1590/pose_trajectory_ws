...
"""autogenerated by genpy from pose_trajectory_controller/FollowPoseTrajectoryActionGoal.msg. Do not edit."""
import sys
...
class FollowPoseTrajectoryActionGoal(genpy.Message):
  _md5sum = "8c2a535dc30183cd9ca8d2238097d017"
  _type = "pose_trajectory_controller/FollowPoseTrajectoryActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','pose_trajectory_controller/FollowPoseTrajectoryGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowPoseTrajectoryActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = pose_trajectory_controller.msg.FollowPoseTrajectoryGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = pose_trajectory_controller.msg.FollowPoseTrajectoryGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.goal.trajectory.axis_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.trajectory.axis_names:
        length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.trajectory.axis_names = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.goal.trajectory.axis_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
