...
"""autogenerated by genpy from pose_trajectory_controller/FollowPoseTrajectoryGoal.msg. Do not edit."""
import sys
...
class FollowPoseTrajectoryGoal(genpy.Message):
  _md5sum = "8f316eb647f63fa701471fe0fb5ee73a"
  _type = "pose_trajectory_controller/FollowPoseTrajectoryGoal"
...
"""
  ...
  _slot_types = ['pose_trajectory_controller/PoseTrajectory','pose_trajectory_controller/AxisTolerance[]','pose_trajectory_controller/AxisTolerance[]','duration']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowPoseTrajectoryGoal, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.trajectory is None:
        self.trajectory = pose_trajectory_controller.msg.PoseTrajectory()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.trajectory.axis_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.trajectory.axis_names:
        length = len(val1)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.trajectory.axis_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
