...
"""autogenerated by genpy from pose_trajectory_controller/PoseTrajectory.msg. Do not edit."""
import sys
...
class PoseTrajectory(genpy.Message):
  _md5sum = "bc871fc6532ea27a94f9a6ccf4ea336b"
  _type = "pose_trajectory_controller/PoseTrajectory"
...
"""
  __slots__ = ['header','axis_names','points']
  _slot_types = ['std_msgs/Header','string[]','pose_trajectory_controller/PoseTrajectoryPoint[]']
