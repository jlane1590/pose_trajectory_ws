...
"""autogenerated by genpy from pose_trajectory_controller/FollowPoseTrajectoryAction.msg. Do not edit."""
import sys
...
class FollowPoseTrajectoryAction(genpy.Message):
  _md5sum = "4e8fc5e4f35542fe20196df53fb4e9cd"
  _type = "pose_trajectory_controller/FollowPoseTrajectoryAction"
...
"""
  ...
  _slot_types = ['pose_trajectory_controller/FollowPoseTrajectoryActionGoal','pose_trajectory_controller/FollowPoseTrajectoryActionResult','pose_trajectory_controller/FollowPoseTrajectoryActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowPoseTrajectoryAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pose_trajectory_controller.msg.FollowPoseTrajectoryActionGoal()
      if self.action_result is None:
        self.action_result = pose_trajectory_controller.msg.FollowPoseTrajectoryActionResult()
      if self.action_feedback is None:
        self.action_feedback = pose_trajectory_controller.msg.FollowPoseTrajectoryActionFeedback()
    else:
      self.action_goal = pose_trajectory_controller.msg.FollowPoseTrajectoryActionGoal()
      self.action_result = pose_trajectory_controller.msg.FollowPoseTrajectoryActionResult()
      self.action_feedback = pose_trajectory_controller.msg.FollowPoseTrajectoryActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.trajectory.axis_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.trajectory.axis_names:
        length = len(val1)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_feedback.feedback.axis_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_feedback.feedback.axis_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.trajectory.axis_names = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.trajectory.axis_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        val1 = pose_trajectory_controller.msg.AxisTolerance()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_feedback.feedback.axis_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_feedback.feedback.axis_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
