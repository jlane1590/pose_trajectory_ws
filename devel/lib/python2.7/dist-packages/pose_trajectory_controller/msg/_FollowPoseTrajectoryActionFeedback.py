...
"""autogenerated by genpy from pose_trajectory_controller/FollowPoseTrajectoryActionFeedback.msg. Do not edit."""
import sys
...
class FollowPoseTrajectoryActionFeedback(genpy.Message):
  _md5sum = "94152c2c345a5f19f9e284620e475e68"
  _type = "pose_trajectory_controller/FollowPoseTrajectoryActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pose_trajectory_controller/FollowPoseTrajectoryFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowPoseTrajectoryActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pose_trajectory_controller.msg.FollowPoseTrajectoryFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pose_trajectory_controller.msg.FollowPoseTrajectoryFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.feedback.axis_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.axis_names:
        length = len(val1)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.feedback.axis_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
